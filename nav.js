...
(function () {
  ...
  const navLinks = [
    ...
    { href: 'executive.html',  label: 'Executives' },
  ...
  <footer class="site-footer">
    <div class="footer-grid">
      <div class="footer-brand-col">
        ...
        <div class="footer-social">
         ...
         <img src="instagram-removebg-preview.png" alt="">
         ...
         <img src="substack-removebg-preview.png" alt="">
          </a>
        </div>
      </div>
      ...
      <div class="footer-col">
        ...
        <ul>
          ...
          <li><a href="executive.html">Executive Team</a></li>
    ...
    <div class="footer-bottom">
      ...
      <span class="footer-back">Built for Africa's future consultants.</span>
    </div>
  </footer>`;
